...
#ifndef TRIANGULATION_COMMON_OPENGL_H_
#define TRIANGULATION_COMMON_OPENGL_H_
  ...
  #include <windows.h>
  /// \todo Do not use variable names "near" and "far".
  #undef near
  #undef far
  #include <GL/GL.h>
  #include <GL/GLU.h>
...
#endif  // ifndef TRIANGULATION_COMMON_OPENGL_H_
