...
#ifndef NHDS_COMMON__STOP_WATCH_H_
#define NHDS_COMMON__STOP_WATCH_H_
...
public:
  StopWatch()
  : fStartTime(boost::posix_time::microsec_clock::universal_time())
  {
  }
  ...
  boost::int64_t ElapsedMilliseconds()
  {
    boost::posix_time::time_duration duration =
    boost::posix_time::microsec_clock::universal_time() - fStartTime;
    return duration.total_milliseconds();
  }
  
private:
  boost::posix_time::ptime fStartTime;
};

#endif // #ifndef NHDS_COMMON__STOP_WATCH_H_
